...
const AddProduct = () => {
  ...
  const handleAddproduct = async (e) => {
    ...
    addProduct(
      ...
      addproducts.model_no,
      addproducts.company,
      addproducts.quantity,
      addproducts.selling_price,
      urls,
  ...
  const uploadImage = () => {
    ...
    Axios.post(
      "https://api.cloudinary.com/v1_1/dp14ek0mf/image/upload",
      formData
    ).then((response) => {
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="mb-3">
                  ...
                  >
                    <option className="text-black" value="no_data">
                      select a product
                    </option>
                    <option className="text-black" value="water purifier">
                      Water purifier
                    </option>
                    <option className="text-black" value="chakki">
                      Chakki (Mill)
                    </option>
                    <option className="text-black" value="chimney">
                      Chimney
                    </option>
                  </select>
                </div>
